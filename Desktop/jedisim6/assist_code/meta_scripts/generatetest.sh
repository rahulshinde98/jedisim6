...
#Run Jedimaster
echo "jedimaster......"
python -u ../old_code/jeditest.py ./physics_settings/${new_config} ${threads}
./jedimakeimage_s ${new_output_folder}/${new_prefix}catalog.txt physics_settings/${new_lens} 15 12288 12288 0.06 0.3 ${new_output_folder}/${new_prefix}HST.fits physics_settings/${new_config}
